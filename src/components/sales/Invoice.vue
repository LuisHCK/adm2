<template>
  ...
  >
            ...
            <table style="width: 100%;">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: left;">
                    {{ sale.created_at | moment('DD/MM/YYYY, h:mm a') }}
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 2.5em;">
      ...
      <tbody>
        <tr v-for="(item, index) in sale.shoppingCart" :key="'item-' + index">
          ...
          <td style="padding: 6px; text-align: right;">C${{ item.subTotal }}</td>
        </tr>
      </tbody>
